...
namespace Wado::FiberSystem {
    ...
    unsigned long WorkerThreadStartFunction(void *param) {
        ...
        DEBUG_LOCAL(DebugLog::WD_MESSAGE, "FiberSystem", ("Idle fiber ID for this core: " + std::to_string(reinterpret_cast<uintptr_t>(Wado::Fiber::WdGetCurrentFiber()))).c_str());
    ...
    const std::vector<System::WdCoreInfo> InitFiberSystem(size_t maxWorkerCount) {
        ...
        DEBUG_LOCAL(DebugLog::WD_MESSAGE, "FiberSystem", ("Idle fiber ID for this core: " + std::to_string(reinterpret_cast<uintptr_t>(idleFiberID))).c_str());
    ...
    void ShutdownFiberSystem() { 
        ...
        DEBUG_GLOBAL(DebugLog::WD_MESSAGE, "FiberSystem", ("Waiting on core " + std::to_string(coreIndex) + " for the other " + std::to_string(threadCount - 1) + " cores to finish").c_str());

        for (size_t i = 0; i < threadCount; ++i) {
            if (i != coreIndex) {
                DEBUG_GLOBAL(DebugLog::WD_MESSAGE, "FiberSystem", ("Waiting for core " + std::to_string(i)).c_str());
        ...
        for (size_t i = 0; i < threadCount; ++i) {
            if (i != coreIndex) {
                DEBUG_GLOBAL(DebugLog::WD_MESSAGE, "FiberSystem", ("Closing thread for core " + std::to_string(i)).c_str());
